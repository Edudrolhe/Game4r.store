...
export default function ResumoPagamento(props: ResumoPagamentoProps) {
    return (
        <View style={styles.container}>
            ...
            <Pressable
                style={[styles.botao, props.finalizando && styles.botaoDesabilitado]}
                onPress={() => props.finalizarCompra?.()}
                disabled={props.finalizando}
            >
                {props.finalizando ? (
                ...
                <Text style={styles.botaoTexto}>
                    {props.finalizando ? 'Finalizando...' : 'Finalizar Compra'}
                </Text>
            </Pressable>
        </View>
    )
