...
import { Moeda, Parcelamento } from '@game4r/core'
...
export default function ResumoPagamento(props: ResumoPagamentoProps) {
    return (
        <div
            ...
            `}
        >
            <span className="text-xl font-semibold text-white">Resumo:</span>
            <div className="flex justify-between">
                <span className="text-zinc-400">Forma de Pagamento:</span>
                <span className="text-white">PIX/Boleto</span>
            </div>
            <div className="flex justify-between">
            ...
            <button
                ...
                className="button bg-pink-600 hover:bg-pink-500 text-white font-semibold flex items-center justify-center gap-2 mt-7"
            >
